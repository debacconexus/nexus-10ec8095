...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Mental Health Services Hub";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Client Case";
process.env.TABLE_NAME = process.env.TABLE_NAME || "client_case_records";
'use strict';
